...
@rem ##########################################################################
@rem
@rem  TestGSheetFake startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and TEST_G_SHEET_FAKE_OPTS to pass JVM options to this script.
...
:fail
rem Set variable TEST_G_SHEET_FAKE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%TEST_G_SHEET_FAKE_EXIT_CONSOLE%" exit 1
exit /b 1
